...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ax_flutter_plugin/ax_flutter_plugin.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/logger_flutter/logger_flutter.framework"
